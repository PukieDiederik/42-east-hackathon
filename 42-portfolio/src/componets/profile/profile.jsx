...
export function Profile() {
  ...
  return (
    <header className="profile">
      ...
      <div className="profile-svg">
        ...
        >
          ...
          <g
            ...
            styles="stroke-miterlimit:10;stroke-width:1.62px;"
          >
            <path
              d="m42.52.81C19.52.81.81,19.52.81,42.53s18.16,41.15,40.68,41.7v716.74h2.07V84.23c22.52-.55,40.67-19.04,40.67-41.7S65.52.81,42.52.81Zm0,81.36c-21.86,0-39.64-17.78-39.64-39.64S20.66,2.88,42.52,2.88s39.64,17.79,39.64,39.65-17.78,39.64-39.64,39.64Z"
              fill="#fff"
       ...
       */}
       <svg id="full" display="block" transform="translate(-0.95 0)" fill="#fff" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 595.28 148.72">
            <defs>
                <linearGradient id="linear-gradient" x1="15%" y1="0%" x2="65%" y2="0%" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-color="#09687a"/>
                    <stop offset="1" stop-color="#169d97"/>
                </linearGradient>
            ...
            <g>
                ...
                <path d="m242.48,82.88c0,21.86-17.78,39.64-39.64,39.64s-39.64-17.78-39.64-39.64,17.78-39.65,39.64-39.65,39.64,17.79,39.64,39.65Z" fill="url(#photo)" stroke="url(#linear-gradient)" stroke-miterlimit="10" stroke-width="1.62"/>
            </g>
        </svg>
    </header>
  );
